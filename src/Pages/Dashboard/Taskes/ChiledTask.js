          ...
          <div className=" d-flex gap-3   py-1  flex-wrap border ">
            ...
            ||(file.split('.').pop())==='jfif'||(file.split('.').pop())==='JPG'?
                    <div className=" d-flex gap-2 align-items-center justify-content-center  flex-column" >
                      <img key={index} src={`http://127.0.0.1:8000/storage/${file}`} width='60px'height='60px' alt="img"></img>                   
                      <p className="m-0">{File_Name(file,index)}</p>
                      {/* <a  href={`http://127.0.0.1:8000/storage/${file}`} >Download</a>  */}
                      <a className="fs-6"  href={`http://127.0.0.1:8000/api/download/${File_Path(file,index)}`} >Download</a>
                  </div>
                  ...
                  <div className=" d-flex gap-2 align-items-center justify-content-center  flex-column" >
                    ...
                    <p className="m-0">{File_Name(file,index)}</p>
                        <a  href={`http://127.0.0.1:8000/api/download/${File_Path(file,index)}`} >Download</a> 
                  </div>
                  :(file.split('.').pop())==='xlsx'?
                  <div className=" d-flex gap-2 align-items-center justify-content-center  flex-column" > 
                  ...
                  {  it.file_paths && it.file_paths.map((item,i)=>            
                      <div key={i} className=" d-flex  flex-wrap  gap-3 align-items-center justify-content-center  "style={{width:'100px'}}> 
                          ...
                          ||(item.split('.').pop())==='jfif' ||(item.split('.').pop())==='JPG'?
                                <div className=" d-flex gap-2 align-items-center justify-content-center  flex-column" >
                                  <img key={i} src={`https://free-001.yemenhosting.com/storage/${item}`} width='60px'height='60px' alt="img"></img>                   
                                ...
                                <p className="m-0 fs-6">{File_Name(item,i)} </p>
                                    ...
                                    <a className="fs-6"  href={`https://free-001.yemenhosting.com/download/${File_Path(item,i)}`} >Download</a>
                              </div>
